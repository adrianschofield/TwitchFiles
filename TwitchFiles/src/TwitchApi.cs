...
namespace TwitchTools
{
    class TwitchApi
    {
        ...
        public TwitchChannelJson TwitchChannelsApi(string user, bool query)
        {
            ...
            if (query)
            {
                ...
                myWebRequest = WebRequest.CreateHttp("https://api.twitch.tv/kraken/search/channels?query=" + user);
            }
            else
            {
            ...
            using (System.IO.Stream s = myWebRequest.GetResponse().GetResponseStream())
            {
                using (System.IO.StreamReader sr = new System.IO.StreamReader(s))
                {
                    ...
                    try
                    {
                        ...
                        {
                            //OK this is pretty bogus and I should have this in a separate function
